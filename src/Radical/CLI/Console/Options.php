<?php
namespace Radical\CLI\Console;

// Based of kohana
class Options {
	/**
	 * Returns one or more command-line options.
	 * Options are specified using
	 * standard CLI syntax:
	 *
	 * php index.php --username=john.smith --password=secret --var="some value
	 * with spaces"
	 *
	 * // Get the values of "username" and "password"
	 * $auth = Options::extract('username', 'password');
	 *
	 * @param
	 *        	string option name
	 * @param
